...
class UVigoAdapter(PortalAdapter):
    portal_name = "uvigo"
    base_url = "https://portalcientifico.uvigo.gal"
    max_list_pages = 25

    def __init__(self, publications_list_url: str | None = None) -> None:
        self._publications_list_url = publications_list_url
    ...
    def _is_portal_url(self, url: str) -> bool:
        parsed = urlparse(url)
        return parsed.netloc.endswith("portalcientifico.uvigo.gal")
    ...
    def seed_endpoints(self) -> dict[str, str]:
        return {
            ...
            "publications": self._publications_list_url or f"{self.base_url}/resultados/publicaciones",
